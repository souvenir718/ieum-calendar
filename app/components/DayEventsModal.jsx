 ...
 */
export default function DayEventsModal({ day, onClose, onEventClick, onAddClick }) {
  if (!day) return null;

  return (
    <div className="modal-overlay day-events-overlay" role="presentation" onClick={onClose}>
      <div

...
- **`오후2`는 2026-07-20부터 폐지** — `duties`에 오후2 행을 만들지 않는다. 편집 대상 슬롯은 `lib/duties.js`의 `EDITABLE_SLOTS = ["오전1","오전2","오후1"]`.
  - 단, `lib/print-config.js`의 오후2 정의는 **의도적으로 남겨둠**(재개 대비). 지우지 말 것.
  - 전체 규칙·재개 방법은 `docs/당직규칙.md` 참고.
